class Parser:
    ...
    def _parse_square_to_general_payment(square_payment_dic):
        ...
        general_payment_square_id = square_payment_dic['id']
        general_payment['general_payment_square_id'] = general_payment_square_id

        general_payment_amount_money = {'amount': square_payment_dic['amount_money']['amount'], 'currency': square_payment_dic['amount_money']['currency']}
        general_payment['general_payment_amount_money'] = general_payment_amount_money
        ...
        if 'app_fee_money' in square_payment_dic:
            ...
            general_payment['app_fee_money'] = {'general_payment_tip_amount': general_payment_app_fee_amount, 'general_payment_tip_currency': general_payment_app_fee_currency}
